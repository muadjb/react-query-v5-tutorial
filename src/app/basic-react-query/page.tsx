...
import { make as FetchWithRescriptQuery } from './FetchWithRescriptQuery.res.js'
...
export default function BasicReactQueryPage() {
  ...
  return (
    <div className='max-w-4xl mx-auto p-6'>
      <div className='mb-6'>
        <h1 className='text-3xl font-bold mb-4'>Basic2 React Query Example</h1>
        <p className='mb-4'>
          This example shows how React Query simplifies data fetching compared to using useEffect.
        </p>
      </div>
      ...
      <div className='mb-6'>
        ...
        <div className='border rounded-lg overflow-hidden shadow-sm'>
          <div className='bg-green-100 p-3 font-medium border-b'>React Query Example</div>
      ...
      <div className='mt-16 border-t-8 border-black bg-yellow-50'>
        <FetchWithRescriptQuery category={category} />
      </div>
    </div>
  )
}
